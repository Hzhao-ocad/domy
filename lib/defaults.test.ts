...
void test('uses the approved dome environment as the default preset', () => {
  assert.deepEqual(defaults, {
    ...
    behavior: 'ripple',
    behaviorPresets: {
      direction: { factor: 0.25, delay: 20, decayStep: 10, decay: 0.2 },
      curiosity: { factor: 0.25, delay: 20, decayStep: 10, decay: 0.2 },
      ripple: { factor: 0.51, delay: 20, decayStep: 10, decay: 0.01 },
      halo: { factor: 0.31, delay: 30, decayStep: 40, decay: 0.09 },
      afterglow: { factor: 0.25, delay: 20, decayStep: 10, decay: 0.04 },
    },
